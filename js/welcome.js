...
$.ajax({
    ...
    data: {
        key: '6EHBZ-B5F3G-X4IQR-Q57A3-UAWDJ-YDBCI',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(113.260541,23.238626, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
